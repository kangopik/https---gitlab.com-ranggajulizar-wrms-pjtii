...
<div class="row tile_count">
  <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
    ...
    <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>10% </i> Dari minggu lalu</span>
  </div>
  <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
    <span class="count_top"><i class="fa fa-clock-o"></i> Kurang dari debit minimum</span>
    <div class="count">123</div>
    <!-- <span class="count_bottom">Pelanggan </i><i class="red"> <i class="fa fa-sort-desc"></i>43% dari minggu lalu</span> -->
    <span class="count_bottom">Pelanggan <i class="green"> <i class="fa fa-sort-desc"></i>10% dari minggu lalu</i>
  </div>
  <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
    <span class="count_top"><i class="fa fa-user"></i> Lebih dari debit max</span>
    <div class="count green">256</div>
    <span class="count_bottom">Pelanggan <i class="red"> <i class="fa fa-sort-asc"></i>43% dari minggu lalu</i>
    </span>
  </div>
  <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="dashboard_graph">
      ...
      <div class="row x_title">
        <div class="col-md-8">
          <h3>Grafik Pemakaian Air Baku <small> Sumber data : Water Meter Reading System</small></h3>
        </div>
        <div class="col-md-4">
...
<div class="row">
  ...
  <div class="col-md-4 col-sm-4 col-xs-12">
    <div class="x_panel tile fixed_height_320">
      ...
      <div class="x_content">
        <h4>Analisa kebutuhan Pasok Air Baku</h4>
